    ...
    variants: {
      variant: {
        ...
        purple:
          ...
          blue:
          "bg-blue-500 text-white shadow-xs hover:bg-blue-600 focus-visible:ring-blue",
        default:
        ...
        newAcctButton:
          "bg-purple-500 text-white shadow-xs hover:bg-purple-600 focus-visible:ring-purple/20 dark:focus-visible:ring-purple/40 dark:bg-purple-600",
