...
type ResponseType = InferResponseType<typeof client.api.categories["bulk"]["$post"]>
type RequestType = InferRequestType<typeof client.api.categories["bulk"]["$post"]>["json"]
...
export const useBulkDelete = () => {
  ...
  const mutation = useMutation<ResponseType, Error, RequestType>({
    ...
    // return data;
    const response = await client.api.categories["bulk"]["$post"]({ json });
